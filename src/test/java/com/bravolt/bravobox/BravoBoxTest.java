...
public class BravoBoxTest extends CamelSpringTestSupport {
  ...
  private static final String ENDPOINT_RENT = "properties:inbound.movie.rent";
  ...
  public void testRentMovie() {
    ...
    request.setImdbId("tt0113243");
    request.setCreditCardNumber("12312312312321");
    request.setEmailAddress("carlushenry@sagetech-llc.com");
    request.setExpirationDate("07/16");
    request.setZipCode("49506");

    String requestJson = gson.toJson(request);
    String responseJson = template.requestBody(ENDPOINT_RENT, requestJson, String.class);
